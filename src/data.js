...
(function (global) {
  ...
  var PROCEDIMENTOS_FORD = [
    ...
    ['Global Catalytic Converter Water Quench', 'CETP 09.02-E-303'],
    ...
    ['Cold Flow Back-pressure', 'CETP 09.00-L-403'],
  ...
  var PROCEDIMENTOS_HYUNDAI = [
    ...
    ['Hanger / Pipe Durability', 'ES 28600-22'],
    ['Backpressure', 'ES 28600-09 - 6.1'],
  ...
  var PROCEDIMENTOS_RSA = [
    ...
    ['Thermal Shock', '34-05-803/--J'],
    ['Hot Shaker', '34-05-803/--J'],
